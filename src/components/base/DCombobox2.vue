<template>
    <div style="position:relative">
        <div id="" class="combobox" :class="{ 'input-error' : isError }">
            <!-- <div class="combobox-icon icon-filter" ></div> -->
            <input type="text" class="combobox-text" v-model="dataComboboxCode"
            ref="inputData" 
        ...
        <div class="combobox__data" v-show="isShowData" @mouseleave="leaveInput">
            ...
            @click="selectData( data[keyCombobox],data[DataComboboxCode], data[DataComboboxName], data[DepreciationRate], data[LifeTime])"
            >{{data[DataComboboxCode]}}</div>
        </div>
    </div>
</template>
...
export default {
    ...
    created() {
        ...
        this.dataComboboxCode = this.ModelInput
    },
    props: ["id", "api", "text", "keyCombobox", "DataCombobox", "DataComboboxCode", "DataComboboxName", "ModelInput", "DepreciationRate", "LifeTime"],
    ...
    methods: {
         ...
         * @param {} selectData 
         */
        selectData(id, selectData, auto, depreciationRate, lifeTime) {
            // this.$refs.inputData.value = selectData;
            this.dataComboboxCode = selectData;
            this.$emit('autoComplete', id, selectData, auto, depreciationRate, lifeTime);
